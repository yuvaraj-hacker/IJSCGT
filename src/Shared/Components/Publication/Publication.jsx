            ...
            <section className="flex flex-col gap-5 max-w-[90rem] md:py-10 py-5  mx-auto md:px-5 px-3">
                <div className="  relative">
                    <section className="flex flex-col gap-5">
                        ...
                        <section className="flex flex-col gap-2">
                            <p className="bg-[#AECC53] rounded-lg p-4">Note: This publication ethics policy is periodically reviewed and updated to reflect the latest best practices in scholarly publishing.</p>
                        </section>
                    </section>
                </div>
            </section>
