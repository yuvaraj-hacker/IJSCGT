      ...
      <div className=" mx-auto px-5 max-w-[92rem]  lg:py-10 py-5">
        <div className="grid grid-cols-1  md:grid-cols-4 sm:grid-cols-2 md:gap-8 gap-4">
          <div className='text-center md:text-left flex flex-col gap-4 justify-between'>
            <Link to='/'>
              <p className=" font-bold md:text-2xl ">IJSCGT</p>
              {/* <img className='bg-white p-2 w-40 md:mx-0   mx-auto' src="/assets/Images/ijscgt.png" alt="" /> */}
            </Link>
            <div className='flex flex-col justify-center md:items-start items-center md:text-left lg:text-base text-sm'>
              <div className='flex gap-3 items-center'>
                <FaEnvelope />
                <p>Email: <a href="mailto:editor@ijscgt.com" className=" ">editor@ijscgt.com</a></p>
              </div>
              <div className='flex gap-3 items-center'>
                <FaGlobe />
                <p>Website: <a href="https://ijscgt.com/" className=" ">www.ijscgt.com</a></p>
              </div>
              <div className=' p-3 '>
